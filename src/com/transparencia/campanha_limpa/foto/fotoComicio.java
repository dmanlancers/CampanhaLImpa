...
public class fotoComicio extends Activity {
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (resultCode == RESULT_OK) {
			...
			File storagePath = new File(Environment.getExternalStorageDirectory() + "/Campanha_Limpa/Comicios/");
			storagePath.mkdirs();

			String nome = Long.toString(System.currentTimeMillis());

			myImage = new File(storagePath, nome+".jpg");
			//String caminhofoto = ("/Campanha_Limpa/Comicios/"+nome+".jpg");
			...
			try {
				...
				out.flush();
				out.close();
				//startActivity(new Intent(fotoComicio.this,Login_fotoComicio.class));


				sendBroadcast(new Intent(Intent.ACTION_MEDIA_MOUNTED, Uri
						.parse("file://"
								+ Environment.getExternalStorageDirectory())));
				startActivity(new Intent(fotoComicio.this,IdComicio.class));
			} catch (Exception e) {
				e.printStackTrace();
			}
