...
public class fotoCartaz extends Activity {
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (resultCode == RESULT_OK) {
			...
			File storagePath = new File(Environment.getExternalStorageDirectory() + "/Campanha_Limpa/Cartazes/");
			storagePath.mkdirs();
			...
			try {
				...
				out.flush();
				out.close();
				startActivity(new Intent(fotoCartaz.this,Login_fotoCartaz.class));



				startActivity(new Intent(fotoCartaz.this,IdCartaz.class));
