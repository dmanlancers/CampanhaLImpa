...
public class UploadFotoComicio extends Activity {
	...
	public static String Idcartaz;
	public static String nomecomicios;
		...
		upload.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				if (bitmap == null) {
					...
					dialog = ProgressDialog.show(UploadFotoComicio.this, "A enviar foto...",
		...
		case PICK_IMAGE:
			if (resultCode == Activity.RESULT_OK) {
				...
				try {
					...
					Toast.makeText(getApplicationContext(), "Erro de Sistema",
							Toast.LENGTH_LONG).show();
					Log.e(e.getClass().getName(), e.getMessage(), e);
				}
			}
	...
	class ImageUploadTask extends AsyncTask<Void, Void, String> {
		...
		protected String doInBackground(Void... unsued) {
			try {
				...
				String desc = titulo_foto.getText().toString();
				String nome    = nomecomicios;
				...
				String postURL = "http://campanhalimpa.transparencia.pt/festa-rest";
		...
		public void setLong(double longitude) {
			...
			Lon = longitude;
			UploadFotoComicio.longitude = longitude;
		}

		public void setLat(double latitude) {
			// TODO Auto-generated method stub
			Lat = latitude;
			UploadFotoComicio.latitude = latitude;
		}
	...
	public void Distritos(String iD_dtr) {
		IdDistritos=iD_dtr;
		UploadFotoComicio.IdDistritos=iD_dtr;
	...
	public void Concelhos(String iD_Conc) {
		IdConcelhos = iD_Conc;
		UploadFotoComicio.IdConcelhos=iD_Conc;

	}

	public void Listas(String iD_Lis) {
		IdLista = iD_Lis;
		UploadFotoComicio.IdLista=iD_Lis;

	}

	public void Cartaz(String iD_Cartaz) {
		// TODO Auto-generated method stub
		Idcartaz = iD_Cartaz;
		UploadFotoComicio.Idcartaz =iD_Cartaz;
	...
	private int VerificaLogin() {
		...
		try {
			...
			Toast.makeText(UploadFotoComicio.this, "ERROR "+e.toString(), Toast.LENGTH_LONG).show();  
		}
		return 0;
	...
	public void Comicios(String Nome_Comicios) {
		nomecomicios = Nome_Comicios;
		UploadFotoComicio.nomecomicios =Nome_Comicios;
	...
	public void concluido(){
		...
		dialog = ProgressDialog.show(UploadFotoComicio.this, "Foto enviada!",
