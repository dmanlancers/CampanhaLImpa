...
public class UploadFotoCartaz extends Activity {
		...
		upload.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				if (bitmap == null) {
					...
					dialog = ProgressDialog.show(UploadFotoCartaz.this, "A enviar foto...",
	...
	class ImageUploadTask extends AsyncTask<Void, Void, String> {
		...
		protected String doInBackground(Void... unsued) {
			try {
				...
				String postURL = "http://campanhalimpa.transparencia.pt/cartaz-rest";
				...
				params.add(new BasicNameValuePair("idCartaz", idCartaz));
		...
		public void setLong(double longitude) {
			...
			Lon = longitude;
			UploadFotoCartaz.longitude = longitude;
		}

		public void setLat(double latitude) {
			// TODO Auto-generated method stub
			Lat = latitude;
			UploadFotoCartaz.latitude = latitude;
		}
	...
	public void Distritos(String iD_dtr) {
		IdDistritos=iD_dtr;
		UploadFotoCartaz.IdDistritos=iD_dtr;
	...
	public void Concelhos(String iD_Conc) {
		IdConcelhos = iD_Conc;
		UploadFotoCartaz.IdConcelhos=iD_Conc;

	}

	public void Listas(String iD_Lis) {
		IdLista = iD_Lis;
		UploadFotoCartaz.IdLista=iD_Lis;
	...
	public void Cartaz(String iD_Cartaz) {
		// TODO Auto-generated method stub
		Idcartaz = iD_Cartaz;
		UploadFotoCartaz.Idcartaz =iD_Cartaz;
		...
		try {
			...
			if (cursor.moveToFirst()){
				do{
					...
					//Toast.makeText(UploadFotoCartaz.this, VarBd, Toast.LENGTH_LONG).show();
			...
			Toast.makeText(UploadFotoCartaz.this, "ERROR "+e.toString(), Toast.LENGTH_LONG).show();  
		}
		return 0;
	...
	public void concluido(){
		...
		dialog = ProgressDialog.show(UploadFotoCartaz.this, "Foto enviada!",
