...
public class RegistarBrinde extends Activity implements OnClickListener{
	...
	public void onClick(View v) {
		...
		case R.id.register:
			...
			break;
		case R.id.login1:
			Intent i = new Intent(this, Login_fotoBrinde.class);
			startActivity(i);
			break;
	...
	class CreateUser extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(RegistarBrinde.this);
		...
		protected String doInBackground(String... args) {
			...
			try {
				...
				if (success == 1) {
					...
					Intent i = new Intent(RegistarBrinde.this, Login_fotoBrinde.class);
					finish();
		...
		protected void onPostExecute(String file_url) {
			...
			pDialog.dismiss();
			if (file_url != null){
				Toast.makeText(RegistarBrinde.this, file_url, Toast.LENGTH_LONG).show();
			}
