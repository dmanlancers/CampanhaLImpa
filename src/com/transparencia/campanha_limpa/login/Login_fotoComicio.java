...
public class Login_fotoComicio extends Activity implements OnClickListener{
	...
	public void onClick(View v) {
		...
		case R.id.login:
			...
			{
				Toast.makeText(Login_fotoComicio.this, "Preencha os campos em falta!", Toast.LENGTH_LONG).show();
	...
	class AttemptLogin extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(Login_fotoComicio.this);
		...
		protected String doInBackground(String... args) {
			...
			try {
				...
				if (success != 0) {
					...
					Intent i = new Intent(Login_fotoComicio.this, fotoCartaz.class);
					finish();
		...
		private void devolveBD(String iDUser) {
			...
			try {
				...
				Toast.makeText(Login_fotoComicio.this, "ERROR "+e.toString(), Toast.LENGTH_LONG).show();  
			}
		...
		protected void onPostExecute(String file_url) {
			...
			if (file_url != null){
				...
				Toast.makeText(Login_fotoComicio.this, file_url, Toast.LENGTH_LONG).show();
			}
